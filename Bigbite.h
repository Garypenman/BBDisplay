...
// Wed Nov  3 22:25:02 2021 by ROOT version 6.22/06
// from TTree T/Hall A Analyzer Output DST
// found on file: gmn_replayed_11594_stream0_seg0_0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        bb_hodotdc_allclus_itrack[30];   //[Ndata.bb.hodotdc.allclus.itrack]
   Int_t           Ndata_bb_hodotdc_allclus_size;
   Double_t        bb_hodotdc_allclus_size[30];   //[Ndata.bb.hodotdc.allclus.size]
   Int_t           Ndata_bb_hodotdc_allclus_tdiff;
   Double_t        bb_hodotdc_allclus_tdiff[30];   //[Ndata.bb.hodotdc.allclus.tdiff]
   Int_t           Ndata_bb_hodotdc_allclus_tmean;
   Double_t        bb_hodotdc_allclus_tmean[30];   //[Ndata.bb.hodotdc.allclus.tmean]
   Int_t           Ndata_bb_hodotdc_allclus_totmean;
   Double_t        bb_hodotdc_allclus_totmean[30];   //[Ndata.bb.hodotdc.allclus.totmean]
   Int_t           Ndata_bb_hodotdc_allclus_xmean;
   Double_t        bb_hodotdc_allclus_xmean[30];   //[Ndata.bb.hodotdc.allclus.xmean]
   Int_t           Ndata_bb_hodotdc_allclus_ymean;
   Double_t        bb_hodotdc_allclus_ymean[30];   //[Ndata.bb.hodotdc.allclus.ymean]
   ...
   Double_t        bb_sh_clus_blk_atime[10];   //[Ndata.bb.sh.clus_blk.atime]
   Int_t           Ndata_bb_sh_clus_blk_col;
   Double_t        bb_sh_clus_blk_col[10];   //[Ndata.bb.sh.clus_blk.col]
   Int_t           Ndata_bb_sh_clus_blk_e;
   Double_t        bb_sh_clus_blk_e[10];   //[Ndata.bb.sh.clus_blk.e]
   Int_t           Ndata_bb_sh_clus_blk_e_c;
   Double_t        bb_sh_clus_blk_e_c[10];   //[Ndata.bb.sh.clus_blk.e_c]
   Int_t           Ndata_bb_sh_clus_blk_id;
   Double_t        bb_sh_clus_blk_id[10];   //[Ndata.bb.sh.clus_blk.id]
   Int_t           Ndata_bb_sh_clus_blk_row;
   Double_t        bb_sh_clus_blk_row[10];   //[Ndata.bb.sh.clus_blk.row]
   Int_t           Ndata_bb_sh_clus_blk_x;
   Double_t        bb_sh_clus_blk_x[10];   //[Ndata.bb.sh.clus_blk.x]
   ...
   Double_t        sbs_hcal_clus_blk_atime[13];   //[Ndata.sbs.hcal.clus_blk.atime]
   Int_t           Ndata_sbs_hcal_clus_blk_col;
   Double_t        sbs_hcal_clus_blk_col[13];   //[Ndata.sbs.hcal.clus_blk.col]
   Int_t           Ndata_sbs_hcal_clus_blk_e;
   Double_t        sbs_hcal_clus_blk_e[13];   //[Ndata.sbs.hcal.clus_blk.e]
   Int_t           Ndata_sbs_hcal_clus_blk_e_c;
   Double_t        sbs_hcal_clus_blk_e_c[13];   //[Ndata.sbs.hcal.clus_blk.e_c]
   Int_t           Ndata_sbs_hcal_clus_blk_id;
   Double_t        sbs_hcal_clus_blk_id[13];   //[Ndata.sbs.hcal.clus_blk.id]
   Int_t           Ndata_sbs_hcal_clus_blk_row;
   Double_t        sbs_hcal_clus_blk_row[13];   //[Ndata.sbs.hcal.clus_blk.row]
   Int_t           Ndata_sbs_hcal_clus_blk_x;
   Double_t        sbs_hcal_clus_blk_x[13];   //[Ndata.sbs.hcal.clus_blk.x]
   Int_t           Ndata_sbs_hcal_clus_blk_y;
   Double_t        sbs_hcal_clus_blk_y[13];   //[Ndata.sbs.hcal.clus_blk.y]
...
#ifdef Bigbite_cxx
Bigbite::Bigbite(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      if (!f || !f->IsOpen()) {
         f = new TFile("gmn_replayed_11594_stream0_seg0_0.root");
      }
      f->GetObject("T",tree);
...
Int_t Bigbite::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Bigbite::LoadTree(Long64_t entry)
{
...
void Bigbite::Show(Long64_t entry)
{
...
Int_t Bigbite::Cut(Long64_t entry)
{

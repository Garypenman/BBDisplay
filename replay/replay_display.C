...
void replay_display(UInt_t runnum=11593, UInt_t firstsegment=0, UInt_t maxsegments=5 )
{

  Long_t nevents=1000;	 
  //Long_t nevents=-1;	 
  Long_t firstevent=0; 
  const char *fname_prefix="e1209019";
  ...
  TString outfilename;
  outfilename.Form( "%s/gmn_replayed_fulltree_%d_stream%d_seg%d_%d.root", prefix.Data(), runnum,
  ...
  TString odef_filename = "replay_display.odef";
  ...
  TString cdef_filename = "replay_display.cdef";
